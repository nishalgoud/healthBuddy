...
import { MY_HEALTH_PATH } from "../constants";
    ...
    <>
          ...
          <Col sm={5}>
            <Card style={{height:'100%'}}>
              <Card.Body>
                ...
                Thousands
                of people are suffering with a range of different symptoms that
                may be misinterpreted for years. Over time they may slowly give
                way to a host of other problems, including fatigue, depression
                and severe gut issues and it seems impossible to get any answers
                from doctors, beyond a repeat prescription.
                </div>
                <Container>
              <video
                src={healthCare2}
      ...
      <Card>
        ...
        <Card.Title as='h1'>What is My Health Buddy?</Card.Title>
          ...
          <div>Make sure your family is up to date on preventive services.See which screening tests and vaccines you or your loved ones need to stay healthy.</div>
